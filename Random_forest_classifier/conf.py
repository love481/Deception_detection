...
# Network and Loss
parser.add_argument('--arc', default='swin_transformer_tiny', type=str, choices=['resnet18', 'resnet50', 'resnet101',
...
parser.add_argument('--resume', default='checkpoints/OpenGprahAU-SwinT_first_stage.pth', type=str, metavar='path', help='path to latest checkpoint (default: none)')
